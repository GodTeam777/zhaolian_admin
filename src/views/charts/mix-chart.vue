<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <span v-show="scope.row.status==0">
         ...
         <span>
         <el-button type="primary"  circle  @click="tongguo(scope.$index, scope.row)">通过</el-button>
        </span>
        &nbsp;
        <span> <el-button type="danger" circle @click="tongguo1(scope.$index, scope.row)">不通过</el-button></span>
          </span>
    ...
    <el-button type="primary" @click="meymoupdate">是</el-button>
  </span>
    </el-dialog>
    ...
    <el-button type="primary" @click="meymoupdate1">是</el-button>
  </span>
    </el-dialog>
  ...
  export default {
    ...
    methods: {
      ...
      tongguo1(index, row){
        ...
        this.bdname=row.bdname
        this.money=row.money
        this.licaiDate=row.licaiDate
        this.zhifutype=row.zhifutype
        this.shouDate=row.shouDate
      ...
      meymoupdate(){
        this.axios({
          url:'http://localhost:10086/prodderupdate',
          method:'POST',
          withCredentials:true,
          data:{
            poid:this.poid,
            ...
            bdname:this.bdname,
            money:this.money,
            licaiDate:this.licaiDate,
            zhifutype:this.zhifutype,
            shouDate:this.shouDate,
            status:this.status
          },
        }).then(res =>{
          this.pb=res.data.rows
      ...
      meymoupdate1(){
        this.axios({
          url:'http://localhost:10086/prodderupdate1',
          method:'POST',
          withCredentials:true,
          data:{
            poid:this.poid,
